...
public class WiFiBox {
     ...
     *
     * @param address is the address of the WiFi box
     * @param port    is the port of the WiFi box (omit this if unsure)
     */
     ...
     *
     * @param host is the host given as hostname such as "domain.tld" or string
     ...
     *
     * @param messages is an array of message codes to send
     * @throws IllegalArgumentException if the length of the array is not 3
    ...
    private byte[] padMessage(int message) {
        byte[] paddedMessage = {(byte) message, 0x55 & 0x00, 0x55};
     ...
     *
     * @param message1 is the first byte of the message to pad
     * @param message2 is the second byte of the message to pad
     * @return is the padded message
     */
    private byte[] padMessage(int message1, int message2) {
        byte[] paddedMessage = {(byte) message1, (byte) message2, 0x55};
        return paddedMessage;
    }
     ...
     *
     * @param message is the message code to send
     * @throws IOException if the message could not be sent
     */
     ...
     *
     * @param message1 is the first byte of the message to send
     * @param message2 is the second byte of the message to send
     * @throws IOException if the message could not be sent
     */
     ...
     * thread.
     *
     * @param messages is the messages to send (in order)
     * @param sleep    is the time to wait between two message in milliseconds
     * @throws IllegalArgumentException if some of the messages in the array don't consist of exactly
     *                                  three bytes
     */
     ...
     */
    public void white() {
        int[] messages = {COMMAND_ALL_WHITE};
     ...
     *
     * @param value is the brightness value to set (between 0 and
     *              WiFiBox.MAX_BRIGHTNESS)
     * @throws IOException              if the message could not be sent
     * @throws IllegalArgumentException if the brightness value is not between 0 and
     *                                  WiFiBox.MAX_BRIGHTNESS
     */
     ...
     *
     * @param group is the number of the group to set the brightness for
     * @param value is the brightness value to set (between 0 and
     *              WiFiBox.MAX_BRIGHTNESS)
     * @throws IOException              if the message could not be sent
     * @throws IllegalArgumentException if group is not between 1 and 4 or the brightness value is
     ...
     * last one that was switched on).
     *
     * @param value is the color value to set (between 0 and
     *              WiFiBox.MAX_COLOR)
     * @throws IOException              if the message could not be sent
     * @throws IllegalArgumentException if the color value is not between 0 and
     *                                  WiFiBox.MAX_COLOR
     */
...
//        sendMultipleMessages(messages, DEFAULT_SLEEP_BETWEEN_MESSAGES);
     ...
     *
     * @param group is the number of the group to set the color for
     * @param value is the color value to set (between 0 and
     *              WiFiBox.MAX_COLOR)
     * @throws IOException              if the message could not be sent
     * @throws IllegalArgumentException if group is not between 1 and 4 or the color value is
